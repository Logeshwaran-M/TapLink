      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          <h1 className="text-3xl md:text-5xl font-black text-blue-900 mb-4 flex items-center gap-4">
            <HiShieldCheck className="text-[#2563eb]" /> Privacy <span className="text-[#60a5fa]">Policy</span>
          </h1>
        ...
        <div className="space-y-10 bg-white/5 p-8 md:p-12 rounded-3xl border border-white/10 backdrop-blur-sm">
          <section>
            <h2 className="text-xl font-bold text-blue-900 mb-4">1. Information Collection</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-blue-900 mb-4">2. Use of Information</h2>
            <p className="leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-blue-900 mb-4">3. Data Security</h2>
            <p className="leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-blue-900 mb-4">4. Contact Us</h2>
            <p className="leading-relaxed text-sm">
