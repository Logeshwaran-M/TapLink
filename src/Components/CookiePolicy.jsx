...
const CookiePolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-300 py-20 px-6">
      <div className="max-w-4xl mx-auto">
        <Link to="/" className="inline-flex items-center gap-2 text-[#60a5fa] font-bold text-xs uppercase tracking-widest mb-10 hover:translate-x-[-4px] transition-transform">
          <HiArrowLeft size={16} /> Back to Home
        </Link>
        
        <div className="mb-12">
          <h1 className="text-3xl md:text-5xl font-black text-blue-900 mb-4 flex items-center gap-4">
            <HiDatabase className="text-[#2563eb]" /> Cookie <span className="text-[#60a5fa]">Policy</span>
          </h1>
        ...
        <div className="space-y-10 bg-white/5 p-8 md:p-12 rounded-3xl border border-white/10 backdrop-blur-sm">
          <section>
            <h2 className="text-xl font-bold text-blue-900 mb-4">1. What are Cookies?</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-blue-900 mb-4">2. Types of Cookies We Use</h2>
            <div className="space-y-4">
              <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                <h3 className="text-[#60a5fa] font-bold text-sm mb-2 uppercase tracking-wider">Essential Cookies</h3>
                <p className="text-xs text-slate-400">Necessary for the website to function correctly (e.g., security and navigation).</p>
              </div>
              <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                <h3 className="text-[#60a5fa] font-bold text-sm mb-2 uppercase tracking-wider">Performance Cookies</h3>
          ...
          <section>
            <h2 className="text-xl font-bold text-blue-900 mb-4">3. Managing Your Preferences</h2>
            <p className="leading-relaxed text-sm">
